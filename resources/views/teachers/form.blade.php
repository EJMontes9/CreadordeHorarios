    ...
    <div id="section-planification" class="hidden border border-blue-200 shadow p-4 rounded-2xl my-5">
        ...
        <div class="flex flex-wrap mb-3">
            <div class="flex flex-col w-full md:w-1/3 mr-3 mb-3">
                ...
                <x-input id="period" class="block mt-1 w-full" type="text" name="period" value="{{ $teacher->period ?? '' }}" required />
            </div>
            <div class="flex flex-col w-full md:w-1/3 mr-3 mb-3">
                <x-label for="teacher_schedule_hours" :value="__('Horas Docente Horario')" />
                <x-input id="teacher_schedule_hours" class="block mt-1 w-full no-spin" type="number" name="teacher_schedule_hours" value="{{ $teacher->teacher_schedule_hours ?? '' }}" required />
            </div>
            <div class="flex flex-col w-full md:w-1/3 mr-3 mb-3">
                <x-label for="class_preparation_hours" :value="__('Horas Preparación Clases:')" />
                <x-input id="class_preparation_hours" class="block mt-1 w-full no-spin" type="number" name="class_preparation_hours" value="{{ $teacher->class_preparation_hours ?? '' }}" required />
            </div>
        </div>
        ...
        <div class="flex flex-wrap mb-3">
            <div class="flex flex-col w-full md:w-1/4 mr-3 mb-3">
                ...
                <x-input id="research_hours" class="block mt-1 w-full no-spin" type="number" name="research_hours" value="{{ $teacher->research_hours ?? '' }}" />
            </div>
            <div class="flex flex-col w-full md:w-1/4 mr-3 mb-3">
                <x-label for="management_hours" :value="__('Horas Gestión:')" />
                <x-input id="management_hours" class="block mt-1 w-full no-spin" type="number" name="management_hours" value="{{ $teacher->management_hours ?? '' }}" />
            </div>
            <div class="flex flex-col w-full md:w-1/4 mr-3 mb-3">
                <x-label for="social_knowledge_management_hours" :value="__('Horas Gestión Social Conocimiento:')" />
                <x-input id="social_knowledge_management_hours" class="block mt-1 w-full no-spin" type="number" name="social_knowledge_management_hours" value="{{ $teacher->social_knowledge_management_hours ?? '' }}" />
            </div>
            <div class="flex flex-col w-full md:w-1/4 mr-3 mb-3">
                <x-label for="pre_professional_practice_tutoring_hours" :value="__('Horas Tutorías Prácticas Pre Profesionales:')" />
                <x-input id="pre_professional_practice_tutoring_hours" class="block mt-1 w-full no-spin" type="number" name="pre_professional_practice_tutoring_hours" value="{{ $teacher->pre_professional_practice_tutoring_hours ?? '' }}" />
            </div>
        </div>
        ...
        <div class="flex flex-wrap mb-3">
            <div class="flex flex-col w-full md:w-1/4 mr-3 mb-3">
                ...
                <x-input id="academic_tutoring_hours" class="block mt-1 w-full no-spin" type="number" name="academic_tutoring_hours" value="{{ $teacher->academic_tutoring_hours ?? '' }}" />
            </div>
            <div class="flex flex-col w-full md:w-1/4 mr-3 mb-3">
                <x-label for="thesis_tutoring_hours" :value="__('Horas Tutorías Titulación:')" />
                <x-input id="thesis_tutoring_hours" class="block mt-1 w-full no-spin" type="number" name="thesis_tutoring_hours" value="{{ $teacher->thesis_tutoring_hours ?? '' }}" />
            </div>
            <div class="flex flex-col w-full md:w-1/4 mr-3 mb-3">
                <x-label for="individual_tutoring_hours" :value="__('Horas Tutorías Individuales:')" />
                <x-input id="individual_tutoring_hours" class="block mt-1 w-full no-spin" type="number" name="individual_tutoring_hours" value="{{ $teacher->individual_tutoring_hours ?? '' }}" />
            </div>
            <div class="flex flex-col w-full md:w-1/4 mr-3 mb-3">
                <x-label for="group_tutoring_hours" :value="__('Horas Tutorías Grupales:')" />
                <x-input id="group_tutoring_hours" class="block mt-1 w-full no-spin" type="number" name="group_tutoring_hours" value="{{ $teacher->group_tutoring_hours ?? '' }}" />
            </div>
        </div>
        ...
        <div class="flex flex-wrap mb-3">
            <div class="flex flex-col w-full md:w-1/4 mr-3 mb-3">
                ...
                <x-input id="complex_thesis_tutoring_hours" class="block mt-1 w-full no-spin" type="number" name="complex_thesis_tutoring_hours" value="{{ $teacher->complex_thesis_tutoring_hours ?? '' }}" />
            </div>
            <div class="flex flex-col w-full md:w-1/4 mr-3 mb-3">
                <x-label for="community_practice_tutoring_hours" :value="__('Horas Tutorías Prácticas Comunitarias:')" />
                <x-input id="community_practice_tutoring_hours" class="block mt-1 w-full no-spin" type="number" name="community_practice_tutoring_hours" value="{{ $teacher->community_practice_tutoring_hours ?? '' }}" />
            </div>
            <div class="flex flex-col w-full md:w-1/4 mr-3 mb-3">
                <x-label for="distributive_hours" :value="__('Horas Distributivo:')" />
                <x-input id="distributive_hours" class="block mt-1 w-full no-spin" type="number" name="distributive_hours" value="{{ $teacher->distributive_hours ?? '' }}" />
            </div>
            <div class="flex flex-col w-full md:w-1/4 mr-3 mb-3">
                <x-label for="utah_hours" :value="__('Horas UTAH:')" />
                <x-input id="utah_hours" class="block mt-1 w-full no-spin" type="number" name="utah_hours" value="{{ $teacher->utah_hours ?? '' }}" />
            </div>
        </div>
        ...
        <div class="flex flex-wrap mb-3">
            <div class="flex flex-col w-full md:w-1/4 mr-3 mb-3">
                ...
                <x-input id="academic_hours" class="block mt-1 w-full no-spin" type="number" name="academic_hours" value="{{ $teacher->academic_hours ?? '' }}" />
            </div>
            <div class="flex flex-col w-full md:w-3/4 mr-3 mb-3">
                <x-label for="managements" :value="__('Gestiones:')" />
                <x-input id="managements" class="block mt-1 w-full" type="text" name="managements" value="{{ $teacher->managements ?? '' }}" />
            </div>
        </div>

        <div class="flex flex-wrap mb-3">
            <div class="flex flex-col w-full md:w-1/2 mr-3 mb-3">
                <x-label for="activities" :value="__('Actividades:')" />
                <x-input id="activities" class="block mt-1 w-full" type="text" name="activities" value="{{ $teacher->activities ?? '' }}" />
            </div>
            <div class="flex flex-col w-full md:w-1/2 mr-3 mb-3">
                <x-label for="research_projects" :value="__('Proyectos Investigación:')" />
                <x-input id="research_projects" class="block mt-1 w-full" type="text" name="research_projects" value="{{ $teacher->research_projects ?? '' }}" />
            </div>
        </div>

        <div class="flex flex-wrap mb-3">
            <div class="flex flex-col w-full">
                <x-label for="subjects_to_teach_current" :value="__('Asignaturas a Dictar Actual:')" />
                <x-input id="subjects_to_teach_current" class="block mt-1 w-full" type="text" name="subjects_to_teach_current" value="{{ $teacher->subjects_to_teach_current ?? '' }}" />
            </div>
        </div>
        <div class="flex justify-between">
