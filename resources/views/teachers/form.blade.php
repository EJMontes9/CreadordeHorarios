<div class="flex justify-center">
    <ol id="progress-bar" class="flex item-center w-full mb-4 sm:mb-5 ml-7 mr-3">
        ...
        <li class="step flex items-center w-1/4 justify-center">
            <span class="text-center mx-5">Información de Planificación</span>
        </li>
    </ol>
</div>
    ...
    <div id="section-planification" class="hidden border border-blue-200 shadow p-4 rounded-2xl my-5">
        ...
        <div class="flex flex-row mb-3">
            ...
            <div class="flex flex-col w-1/4 mr-3">
                ...
                <x-input id="management_hours" class="block mt-1 w-full no-spin" type="number"
                    name="management_hours" value="{{ $teacher->management_hours ?? '' }}" />
            </div>
            <div class="flex flex-col w-1/4 mr-3">
            ...
            <div class="flex flex-col w-1/4 mr-3">
                ...
                <x-input id="pre_professional_practice_tutoring_hours" class="block mt-1 w-full no-spin"
                    type="number" name="pre_professional_practice_tutoring_hours"
        ...
        <div class="flex flex-row mb-3">
            <div class="flex flex-col w-1/2 mr-3">
                ...
                <x-input id="activities" class="block mt-1 w-full" type="text" name="activities"
                    value="{{ $teacher->activities ?? '' }}" />
            </div>
            <div class="flex flex-col w-1/2 mr-3">
                <x-label for="research_projects" :value="__('Proyectos Investigación:')" />
                <x-input id="research_projects" class="block mt-1 w-full" type="text" name="research_projects"
                    value="{{ $teacher->research_projects ?? '' }}" />
            </div>
        </div>
        ...
        <div class="flex flex-row mb-3">
            <div class="flex flex-col w-full">
                ...
                <x-input id="subjects_to_teach_current" class="block mt-1 w-full" type="text"
                    name="subjects_to_teach_current" value="{{ $teacher->subjects_to_teach_current ?? '' }}" />
            </div>
        </div>
        <div class="flex justify-between">
