<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://www.linkedin.com/posts/elo%C3%ADsa-isabel-baja%C3%B1a-heredero-903713207_as%C3%AD-ser%C3%A1-activity-6943322085985308672-X26c/"
                                                                                          class="hover:underline">Eloisa Bajaña Heredero™</a>. All Rights Reserved.
          </span>
